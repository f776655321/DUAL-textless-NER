...
def main():
    ...
    for mode in ["train", "validation", "test"]:
        ...
        if mode == 'train':
            ...
            df = pd.read_csv('code-data-sa/' + mode + f'_ans.csv')
        ...
        if mode == "train":
            ...
            # NewDf.to_csv('code-data/' + mode + f'_code_ans_sampling_positive_{K}.csv',index=False)
            NewDf.to_csv('code-data-sa/' + mode + f'_code_ans_balance.csv',index=False)
        else: 
            # NewDf.to_csv('code-data/' + mode + f'_code_ans_slue.csv',index=False)
            NewDf.to_csv('code-data-sa/' + mode + f'_code_ans.csv',index=False)
