	...
	if True:
		for mode in ["train", "validation"]:
			if mode == "train":
				...
				df = pd.read_csv("code-data/train_code_ans_negative_yn.csv")    
				# df = pd.read_csv("code-data/train_code_ans_sampling_negative_2.csv")    
			elif mode == "validation":
				df = pd.read_csv("code-data/validation_code_ans_yn.csv")   
				
			code_dir = os.path.join("code-data", 'question-code-DAC-yn')
			# TODO
