...
for ner, prompt in NER.items():
       ...
       audio_path = f"code-data-sa/question-prompts-SA/{ner}.mp3"
...
output_dir =  f"code-data-sa/question-code-SA"
if not os.path.isdir(output_dir):
    os.mkdir(output_dir)
for ner, prompt in NER.items():
    audio_file_path = f"code-data-sa/question-prompts-SA/{ner}.mp3"
