...
parser.add_argument('--data_dir', default='code-data-sa', type=str)
parser.add_argument('--model_path', default='SA/checkpoint-5000', type=str)
...
class SQADevDataset(Dataset):
    def __init__(self, data_dir):
        ...
        code_dir = os.path.join(data_dir, 'question-code-SA')
